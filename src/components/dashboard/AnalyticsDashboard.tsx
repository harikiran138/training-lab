  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 mt-16 pt-12 border-t border-slate-100">
        <div className="lg:col-span-3 bg-white p-8 rounded-xl border border-slate-100 flex items-center justify-center text-slate-400 italic text-sm">
          AI insights are being recalculated based on the latest data stream...
        </div>
